...
public class aliAbad {

    MapsActivity mapsActivity;


    public aliAbad(Context context) {
...
//پتاسیم
    ...
    public String[] getKPanbe(){
        ...
        }else if(so4>=200 && so4<230){
            String[] result={"2","3","4","5","6","80","150","210","240","270"};
            return result;
    ...
    public String[] getKGandom(){
        ...
        if(so4<200 && so4!=0){
            ...
            String[] result={"2","3","4","5","6","0","0","15","45","65"};
            return result;
...
//table 8
    ...
    public String[] getKKolza(){
        ...
        if(so4<200 && so4!=0){
            ...
            String[] result={"1000","1400","1800","2200","2600", "3000", "3400", "0", "0","0","0","20","30","40"} ;
            return result;
