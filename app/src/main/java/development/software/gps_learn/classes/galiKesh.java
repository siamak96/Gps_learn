...
public class galiKesh {
    MapsActivity mapsActivity;


    public galiKesh(Context context) {
...
//پتاسیم
    ...
    public String [] getPGandom(){
        ...
        if(so4<7 && so4!=0){
            Log.e("error","oc3"+so4);
            String[] result={"2","3","4","5","6","7","140","170","20","260","290","310"};
            return result;
...
// دی امونیوم فسفات
        if(so4<7 && so4!=0){
            ...
            String[] result={"3","4","5","6", "7", "8", "75", "105","145","95","245","285"} ;
            return result;
