...
public class nodehMalak {
    /// sum of tables == 14
    MapsActivity mapsActivity;


    public nodehMalak(Context context) {
...
//پتاسیم
        ...
        } else if(so4>=12 && so4<15){
            String[] result={"2","3","4","5","6","40","80","120","150","180"};
            return result;
    ...
    public String[] getKPanbe(){
        ...
        if(so4<170 && so4!=0){
            Log.e("error","oc3"+so4);
            String[] result={"2","3","4","5","6","130","230","280","320","350"};
            return result;
        }else if (so4>=170 && so4<200){
            Log.e("error","oc3"+so4);

            String[] result={"2","3","4","5","6","110","200","250","290","320"};
            return result;
    ...
    public String [] getPGandom(){
        ...
        if(so4<10 && so4!=0){
            ...
            String[] result={"2","3","4","5","6","7","0","30","80","110","140","160"};
            return result;
    ...
    public String[] getKGandom(){
        ...
        if(so4<170 && so4!=0){
            ...
            String[] result={"2","3","4","5","6","25","45","65","85","105"};
            return result;
...
//table 8
        ...
        if(so4<10 && so4!=0){
            ...
            String[] result={"1000","1400","1800","2200","2600", "3000", "3400", "20", "40","60","80","100","120","135"} ;
            return result;
    ...
    public String[] getKKolza(){
        ...
        if(so4<170 && so4!=0){
            ...
            String[] result={"1000","1400","1800","2200","2600", "3000", "3400", "25", "40","55","70","85","100","115"} ;
            return result;
...
//table 10 colomn 7 7
        ...
        if(so4<10 && so4!=0){
            ...
            String[] result={"1","1.5","2","2.5","3", "3.5", "4", "0", "0","25","35","60","65","70"} ;
            return result;
    ...
    public String[] getKSoya(){
        ...
        if(so4<170 && so4!=0){
            ...
            String[] result={"1","1.5","2","2.5","3", "3.5", "4", "35", "65","95","130","150","170","180"} ;
            return result;
...
// دی امونیوم فسفات
        if(so4<10 && so4!=0){
            ...
            String[] result={"3","4","5","6", "7", "8", "50", "75","115","150","180","205"} ;
            return result;

        } else if(so4>=12 && so4<15){
            String[] result={"3","4","5","6", "7", "8", "50", "50","85","110","135","155"} ;
            return result;
