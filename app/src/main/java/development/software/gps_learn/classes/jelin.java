...
//پتاسیم
        ...
        }else if (so4>=13 && so4<15){
            String[] result={"2","3","4","5","6","30","70","110","140","170"};
            return result;
    ...
    public String[] getKPanbe(){
        ...
        if(so4<150 && so4!=0){
            ...
            return result;
        }else if (so4>=250 && so4<260){
            Log.e("error","oc3"+so4);
            String[] result={"2","3","4","5","6","0","80","120","160","190"};
            return result;
        }else if (so4>=260){
            Log.e("error","oc3"+so4);
            String[] result={"2","3","4","5","6","0","70","110","150","180"};
            return result;
        }else {
            String[] result={""};
            return result;
    ...
    public String [] getPGandom(){
        ...
        if(so4<13 && so4!=0){
            ...
            String[] result={"2","3","4","5","6","7","0","20","50","80","110","130"};
            return result;
...
//table 8
        ...
        if(so4<13 && so4!=0){
            ...
            String[] result={"1000","1400","1800","2200","2600", "3000", "3400", "15", "35","55","75","95","115","130"} ;
            return result;
...
// دی امونیوم فسفات
        if(so4<13 && so4!=0){
            ...
            String[] result={"3","4","5","6", "7", "8", "0", "50","80","105","125","145"} ;
            return result;
